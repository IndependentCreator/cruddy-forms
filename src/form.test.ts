...
describe( "Form Test Suite", function () {
    ...
    describe( "Form Tests", function () {
        ...
        it( "tests getHTML - supplied values", async function () {
            const html = form.getHTML( { password: "mypass", username:"myuser" } );
            ...
            const input1Value = input1.getAttribute( "value" );
            expect( input1Value ).toBe( "mypass" );
            tw.parentNode();
            ...
            const input2Value = input2.getAttribute( "value" );
            expect( input2Value ).toBe( "myuser" );
        } );
        ...
        it( "tests getHTML - no options", async function () {
            ...
            // Since there's no hint, there shouldn't be a child div with class="requirements"
            // Since there are no errors, there shouldn't be a child div with class="error"
